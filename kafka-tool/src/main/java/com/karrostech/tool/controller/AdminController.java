...
import com.karrostech.tool.util.DateTimeUtil;
...
public class AdminController {
    ...
    @ResponseBody
    @GetMapping("/bulk-config")
    public BulkConfigSetting getBulkConfig() {
        return adminService.getBulkConfig();
    }

    @ResponseBody
    @PutMapping("/bulk-config")
    public boolean updateBulkConfig(@RequestBody BulkConfig bulkConfig) {
        return adminService.updateBulkConfig(bulkConfig);
    }
