package com.karrostech.tool.manager;
...
import com.karrostech.tool.pool.AdminClientConnectionPoolWrapper;
import com.karrostech.tool.pool.ConsumerLagConnectionPoolWrapper;
...
public class KafkaConnectorManager {
    ...
    public void init() {
        ...
        for (Environment env : envs) {
            // prevent connection error from k8s to kafka
            if (Environment.NON_DEV.equals(env) || Role.master.name().equalsIgnoreCase(role)) {
